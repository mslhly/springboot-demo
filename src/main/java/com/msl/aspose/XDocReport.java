...
public class XDocReport {
    ...
    public static void main(String[] args) throws Exception {
        String outPath = "/Users/msl/Desktop/关于确认2020年度个税专项附加扣除的通知.docx";
        wordConverterToPdf(outPath, outPath.replace("docx", "pdf"), "/Users/msl/Desktop/font/simfang.ttf", BaseFont.IDENTITY_H);
    }
